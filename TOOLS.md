...
Authenticated via `gh` credential helper (uses GITHUB_TOKEN). Commits as `rajsinghtechbot <king360raj@gmail.com>`.

> **Note:** Workspace includes `.gitconfig` with `credential.helper = gh`
